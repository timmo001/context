...
const logo = logoRaw.replace(
  ...
  '<svg x="120" y="175" width="280" height="280" viewBox="0 0 36 36">',
);
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <g font-family="${fontStack}" fill="#ffffff">
    <text x="470" y="300" font-size="104" font-weight="700">Context</text>
    <text x="474" y="372" font-size="38" fill-opacity="0.88">Deterministic repository context</text>
    <text x="474" y="420" font-size="38" fill-opacity="0.88">for humans and agents.</text>
    <text x="474" y="500" font-size="30" fill="#4f9cff">context.timmo.dev</text>
  </g>
</svg>`;
